...
export function createBlankEvent(
  ...
  return {
    ...
    laborOvertime: Boolean(partial.laborOvertime),
    laborOvertimeHours: Number(partial.laborOvertimeHours) || 0,
    laborApplyAllowance: Boolean(partial.laborApplyAllowance),
